...
create_t2_or <- function(df, overall = FALSE) {
  df %>%
    mutate(across(SOFA1:SOFA6, ~ ifelse(. > 1, 1, .))) %>%
...
create_t3 <- function(df, outcome = dead28c, overall = FALSE) {
  ...
  vars <- names(sort_var(df, acenitobacter:vibrio_v))
  df %>%
    zap_labels() %>%
    select(!!outcome, vars) %>%
...
>>>>>>> 9936796bb49d7823754f49a2b4fd3605508f61b1
  )
...
var_label(df_enr) <- list(
  acenitobacter    = paste0(var_label(df_enr$acenitobacter), 
                            ' (', sum(df_enr$acenitobacter_i), ifelse(sum(df_enr$acenitobacter_i) == 1,' isolation)',' isolations)')),
  ...
  acinetobacter    = paste0(var_label(df_enr$acinetobacter), 
                            ' (', sum(df_enr$acinetobacter_i), ifelse(sum(df_enr$acinetobacter_i) == 1,' isolation)',' isolations)')),
  aerobic          = paste0(var_label(df_enr$aerobic), 
                         ' (', sum(df_enr$aerobic_i), ifelse(sum(df_enr$aerobic_i) == 1,' isolation)',' isolations)')),
  aeromonas_s      = paste0(var_label(df_enr$aeromonas_s), 
                         ' (', sum(df_enr$aeromonas_s_i), ifelse(sum(df_enr$aeromonas_s_i) == 1,' isolation)',' isolations)')),
  aeromonas_v      = paste0(var_label(df_enr$aeromonas_v), 
                         ' (', sum(df_enr$aeromonas_v_i), ifelse(sum(df_enr$aeromonas_v_i) == 1,' isolation)',' isolations)')),
  ...
  streptococcus_ag = paste0(var_label(df_enr$streptococcus_ag), 
                         ' (', sum(df_enr$streptococcus_ag_i), ifelse(sum(df_enr$streptococcus_ag_i) == 1,' isolation)',' isolations)')),
  ...
  streptococcus_py = paste0(var_label(df_enr$streptococcus_py), 
                         ' (', sum(df_enr$streptococcus_py_i), ifelse(sum(df_enr$streptococcus_py_i) == 1,' isolation)',' isolations)')),
  streptococcus_sa = paste0(var_label(df_enr$streptococcus_sa), 
                         ' (', sum(df_enr$streptococcus_sa_i), ifelse(sum(df_enr$streptococcus_sa_i) == 1,' isolation)',' isolations)')),
  streptococcus_sv = paste0(var_label(df_enr$streptococcus_sv), 
                         ' (', sum(df_enr$streptococcus_sv_i), ifelse(sum(df_enr$streptococcus_sv_i) == 1,' isolation)',' isolations)')),
  streptopylogen_a = paste0(var_label(df_enr$streptopylogen_a), 
                         ' (', sum(df_enr$streptopylogen_a_i), ifelse(sum(df_enr$streptopylogen_a_i) == 1,' isolation)',' isolations)')),
  vibrio_f         = paste0(var_label(df_enr$vibrio_f), 
                         ' (', sum(df_enr$vibrio_f_i), ifelse(sum(df_enr$vibrio_f_i) == 1,' isolation)',' isolations)')),
  vibrio_v         = paste0(var_label(df_enr$vibrio_v), 
                         ' (', sum(df_enr$vibrio_v_i), ifelse(sum(df_enr$vibrio_v_i) == 1,' isolation)',' isolations)'))
)
...
t2 <- tbl_stack(list(t2_un, t2_risk, t2_pui, t2_dx, t2_or, t2_cul_s, t2_rdt, t2_trt),
