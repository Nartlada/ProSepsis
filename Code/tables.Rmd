...
df_scr <-
<<<<<<< HEAD
  read_sas("C:/MyD/Sepsis_Pro/MF/tblPart1.sas7bdat", NULL) %>%
  mutate(
    infect = ifelse(
      IFTropSep == TRUE |
        IFRespiratory == TRUE |
...
=======
  read_sas(
    ...
    "C:/MyD/Sepsis_Pro/MF/prosepsis.sas7bcat"
>>>>>>> 0330359f43563c450bd821178c384855dcd535e5
  )

# Enrollment
df_enr <-
<<<<<<< HEAD
  read_sas("C:/MyD/Sepsis_Pro/MF/psmast.sas7bdat", NULL) %>%
=======
  read_sas(
